...
export interface IFoodClient {
    getTodaysMenu(): Observable<FileResponse>;
}
...
export class FoodClient implements IFoodClient {
    ...
    getTodaysMenu(): Observable<FileResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTodaysMenu(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTodaysMenu(response_ as any);
                } catch (e) {
    ...
    protected processGetTodaysMenu(response: HttpResponseBase): Observable<FileResponse> {
